...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td class="ct_write01"><input type="text" name="Input3" class="ct_input_g" style="width:370px; height:19px" value="삼성 노트북 센스 X15-JUMP2" ></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td height="55" class="ct_write01">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">
						<select name="select6" class="ct_input_g" style="width:100px">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="Input2222" class="ct_input_g" style="width:120px; height:19px; text-align:right" value="1"> 개
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="Input2222" class="ct_input_g" style="width:120px; height:19px; text-align:right" value="500000"> 원
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<textarea name="Text3333" class="ct_input_g" cols="80" rows="4" >센트리노 1.5G CPU이고 DDR 256M 추가해서 DDR 512M, 하드 60G 입니다.
