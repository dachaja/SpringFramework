...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="password" name="password" class="ct_input_g" style="width:100px; height:19px">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="password" name="password2" class="ct_input_g" style="width:100px; height:19px">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="ssn" class="ct_input_g" style="width:100px; height:19px" onChange="javascript:calcAge();">
			-제외, 13자리 입력
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="birthDay" class="ct_input_g" style="width:100px; height:19px">
			...
			<input type="radio" name="slYn" class="ct_input_g" value="Y" checked> 양력
			<input type="radio" name="slYn" class="ct_input_g" value="N"> 음력
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="age" class="ct_input_g" style="width:100px; height:19px;text-align:right">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="addr" class="ct_input_g" style="width:370px; height:19px">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<input type="text" name="phone2" class="ct_input_g" style="width:100px; height:19px">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="file" name="realImageFile" class="ct_input_g" style="width:309px; height:19px">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">
						<input type="text" name="email1" class="ct_input_g" style="width:100px; height:19px" onChange="check_email(this.form);">@
						...
						<input type="text" name="email" class="ct_input_g" readonly style="display:none;width:200px;">
					</td>
				</tr>
				<tr>
					<td height="22">
