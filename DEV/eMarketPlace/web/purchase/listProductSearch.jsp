...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		<td align="right">
			...
			<input type="text" name="searchKeyword" value="<%= keyword %>" class="ct_input_g" style="width:150px; height:19px">
		</td>
		<td align="right">
			A/S 여부&nbsp;&nbsp;
		</td>
		<td align="left">
			<select name="searchAsYn" class="ct_input_g" style="width:80px">
