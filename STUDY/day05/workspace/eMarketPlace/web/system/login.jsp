        ...
        <tr>
          ...
          <td width="345" align="left" valign="top" background="<c:url value='/images/login02.gif'/>"><table width="100%" height="220" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                ...
                <td height="30">
                  <input type="text" name="userId"  class="ct_input_g" style="width:180px; height:19px"/>          
          		</td>
              ...
              <tr> 
                ...
                <td height="30">                    
                    <input type="password" name="password" class="ct_input_g" style="width:180px; height:19px" onKeyPress="if(event.keyCode==13) fncLogin();">
                </td>
                <td width="20" height="30">&nbsp;</td>
              </tr>
              <tr> 
