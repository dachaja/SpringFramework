...
<%@ page import="com.sds.emp.services.user.vo.UserVO" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="userId" class="ct_input_bg" style="width:100px; height:19px" value="<%= userVO.getUserId() %>" readonly>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="userName" class="ct_input_g" style="width:100px; height:19px" value="<%= userVO.getUserName() %>">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="ssn" class="ct_input_g" style="width:100px; height:19px" onChange="javascript:calcAge();" value="<%= EmpUtil.null2str(userVO.getSsn()) %>">
			-제외, 13자리 입력
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="birthDay" class="ct_input_g" style="width:100px; height:19px" value="<%= EmpUtil.null2str(userVO.getBirthDay()) %>">
			...
			<input type="radio" name="slYn" class="ct_input_g" value="Y" <%= EmpUtil.null2str(userVO.getSlYn()).equals("Y") ? "checked" : "" %>> 양력
			<input type="radio" name="slYn" class="ct_input_g" value="N" <%= EmpUtil.null2str(userVO.getSlYn()).equals("N") ? "checked" : "" %>> 음력
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="age" class="ct_input_g" style="width:100px; height:19px;text-align:right" value="<%= EmpUtil.null2str(userVO.getAge()) %>">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="addr" class="ct_input_g" style="width:370px; height:19px" value="<%= EmpUtil.null2str(userVO.getAddr()) %>">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<input type="text" name="phone2" class="ct_input_g" style="width:100px; height:19px" value="<%= cellPhone.substring(cellPhone.indexOf("-")+1) %>">
			
			<input type="hidden" name="cellPhone" class="ct_input_g" value="<%= cellPhone %>">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">
						...
						<input type="text" name="email1" class="ct_input_g" style="width:100px; height:19px" onChange="check_email(this.form);" value="<%= email.indexOf("@") > 0 ? email.substring(0, email.indexOf("@")) : "" %>">
						<select name="email_list" class="ct_input_g" style="width:100px" onChange="check_email(this.form);">
						...
						<input type="text" name="email" class="ct_input_g" readonly style="display:none;width:200px;" value="<%= email %>">
						<script language="JavaScript">
