...
<%@ page import="com.sds.emp.services.sale.vo.SaleVO" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		<td align="right">
			...
			<input type="text" name="searchKeyword" value="<%= keyword %>" class="ct_input_g" style="width:150px; height:19px" fieldTitle="검색어" maxLength="50" char="s">
		</td>
		<td align="right" width="150">
			거래상태
			<select name="searchTranStatusCode" class="ct_input_g" style="width:80px">
