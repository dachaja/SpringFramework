package com.sds.emp.view.controller.user;
...
public class UserController {
	...
	public String addUserView(Model model) throws Exception {
		ArrayList<CodeVO> cellPhoneCodeList = codeService.getCodeList("A01");
		ArrayList<CodeVO> emailCodeList = codeService.getCodeList("A02");		
